...
Sometimes you want to run 100s of jobs, so submitting all of them becomes kind of a pain in the ass. The SLURM workaround for this is called a **job array**. In this case 
